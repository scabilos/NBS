...
<HTML>
	<head>
		...
		<style>
			...
			table {border:1px solid; font-size:14px; margin-left:auto; margin-right:auto; margin-bottom:50px;}
    ...
    <BODY>
        ...
        <div style="margin-left:500px; margin-bottom:35px;">   <!-- Tennivalo: Hover-nel legyen inline, nem fuggoleges-->
            <div id="dropdown">
